...
<div id="bo_gall" style="width:<?php echo $width; ?>">
    ...
    <ul id="gall_ul" class="gall_row">
        <?php for ($i=0; $i<count($list); $i++) {
         ...
         ?>
        <li class="<?php echo implode(' ', $classes); ?> gall_list">
            <div class="gall_box">
	...
	<div class="bo_fx">
		<div class="clearfix">
			...
			<ul class="btn_bo_user">
				...
				<?php if ($is_admin) { ?><li class="bo_fx_write"><a href="<?php echo $write_href ?>" class="btn_b02 btn btn_write">글쓰기</a></li><?php } ?>
			</ul>
			<?php } ?>
		</div>                
	</div>
