...
<article id="bo_v">
   <div class="inner">
    ...
    <section id="bo_v_info">
        <h2>페이지 정보</h2>
        <span class="sound_only">작성자</span><strong class="bo_v_writer">작성자<span class="bar"></span><?php echo $view['name'] ?><?php if ($is_ip_view) { echo "&nbsp;($ip)"; } ?></strong>
        <!-- <span class="sound_only">댓글</span><strong><a href="#bo_vc">댓글 <?php echo number_format($view['wr_comment']) ?>건</a></strong> -->
        <span class="sound_only">조회</span><strong class="bo_v_view">조회<span class="bar"></span><?php echo number_format($view['wr_hit']) ?>회</strong>
        <strong class="if_date"><span class="sound_only">등록일</span>등록일<span class="bar"></span><?php echo date("y-m-d", strtotime($view['wr_datetime'])) ?></strong>
    </section>
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_nb">
            <?php if ($prev_href) { ?><li class="btn_prv clearfix">
                <span class="nb_tit"><i class="fas fa-chevron-up"></i></span><a href="<?php echo $prev_href ?>"><?php echo $prev_wr_subject;?>
                    <span class="nb_date"><!-- <?php echo str_replace('-', '.', substr($prev_wr_date, '2', '8')); ?> --></span></a> </li><?php } ?>
            <?php if ($next_href) { ?><li class="btn_next clearfix"><span class="nb_tit"><i class="fas fa-chevron-down"></i></span><a href="<?php echo $next_href ?>"><?php echo $next_wr_subject;?>  <span class="nb_date"><!-- <?php echo str_replace('-', '.', substr($next_wr_date, '2', '8')); ?> --></span></a></li><?php } ?>
        </ul>
        <?php } ?>
        <?php
