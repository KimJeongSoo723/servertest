...
<!-- 게시판 목록 시작 { -->
<div id="bo_list" class="table_pb" style="width:<?php echo $width; ?>">
    <div class="inner">
		<!-- 게시판 검색 시작 { -->
        <div class="board_search">
            <fieldset id="bo_sch">
                ...
                <form name="fsearch" method="get">
                    ...
                    <button type="submit" value="검색" class="sch_btn"><img src="<?=G5_THEME_IMG_URL?>/search_icon.png"><span class="sound_only">검색</span></button>
                </form>
            </fieldset>
        </div>
        <!-- 게시판 검색 끝 { -->
                ...
                <table>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="bt_wr">작성자</th>
                            <!--th scope="col">조회</th-->
                            <?php if ($is_good) { ?><th scope="col"><a><?php echo subject_sort_link('wr_good', $qstr2, 1) ?>추천 <i class="fa fa-sort" aria-hidden="true"></i></a></th><?php } ?>
                            <?php if ($is_nogood) { ?><th scope="col"><a><?php echo subject_sort_link('wr_nogood', $qstr2, 1) ?>비추천 <i class="fa fa-sort" aria-hidden="true"></i></a></th><?php } ?>
                            <th scope="col">등록일</th>
                        </tr>
                    </thead>
                    <tbody>
            ...
            <div class="bo_fx">
                <div class="clearfix">
                    ...
                    <ul class="btn_bo_user">
                        ...
                        <?php } ?>
                        <?php if ($is_admin) { ?><li><a href="<?php echo $list_href ?>" class="btn_b01 btn btn_list">목록</a></li><?php } ?>
        ...
        <div class="pg_area"><?php echo $write_pages;  ?></div>
