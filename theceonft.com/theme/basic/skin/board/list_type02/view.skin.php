...
<article id="bo_v">
   <div class="inner">
    ...
    <section id="bo_v_info" class="bo_v_info">
        <h2>페이지 정보</h2>
		...
		<strong class="bo_v_view"><span class="sound_only">조회</span>조회<span class="bar"></span><?php echo number_format($view['wr_hit']) ?>회</strong>
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_nb">
            <?php if ($prev_href) { ?><li class="btn_prv clearfix"><span class="nb_tit"><i class="fas fa-chevron-up"></i></span><a href="<?php echo $prev_href ?>"><?php echo $prev_wr_subject;?><span class="nb_date"><!-- <?php echo str_replace('-', '.', substr($prev_wr_date, '2', '8')); ?> --></span></a> </li><?php } ?>
