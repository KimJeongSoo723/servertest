            ...
            <div class="gall_box">
                ...
                <div class="gall_con">
					...
					<?if($is_admin){?>
					 ...
					 <?}else{?>
					 <a onClick="fnGoSlide('<?=$i?>');" class="gall_text_href">
					 <?}?>
...
$(document).scroll(function(){
	...
	function fnMore(){
		$.ajax({
			type: "POST",
			url: "<?=G5_URL?>/sub/ajax.gall_type.more2.php",
...
<div class="type8_popbg"></div>
	<div class="type8_popbox">
		<a class="type8_popbox_x"></a>
		<div class="type8_scr">
			<div class="swiper-container type8_swiper2">
				<ul class="swiper-wrapper">
					...
					<li class="swiper-slide sub02_slide sub02_slide2_<?=$i?> slideActive">
						<div class="type8_pop_wrap">
							<p class="tit"><?=$row['wr_subject']?></p>
							<?php 
								$youtube_link = $row['wr_10'];
				...
				<div class="swiper-button-next type8_arr type8_next  type8_next2"></div>
				<div class="swiper-button-prev type8_arr type8_prev type8_prev2"></div>
			</div>			
		</div>
	</div>
</div>
<script>
var swiper2 = new Swiper('.type8_swiper2', {
	loop: true,
	navigation: {
		nextEl: '.type8_next2',
		prevEl: '.type8_prev2',
