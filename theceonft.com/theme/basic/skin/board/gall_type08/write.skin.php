   ...
   <div class="inner">
    ...
    <div class="bo_w_select write_div">
		...
		<select name="wr_1" id="wr_1">
            <option value="0">메인 노출X</option>
            <option value="1">메인 노출 (최대 8개)</option>
        </select>
    </div>
    <?php } ?>
	...
	<!-- <div class="bo_w_tit write_div">
        <label for="wr_2" class="sound_only">노출순서<strong>필수</strong></label>
        <div id="autosave_wrapper write_div">
            <input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" required class="frm_input full_input required" size="50" maxlength="255" placeholder="노출 순서(낮은숫자일수록 상위노출)">
        </div>
    </div> -->
    <div class="bo_w_tit write_div">
	...
	<div class="bo_w_link write_div">
        <label for="wr_10"><i class="fab fa-youtube"></i><span class="sound_only">동영상</span></label>
        <input type="text" name="wr_10" value="<?php echo $wr_10 ?>" id="wr_10" class="frm_input full_input" size="50" placeholder="예) https://www.youtube.com/watch?v=9bZkp7q19f0">
    </div>
    ...
    <?php } ?>
	<p style="color:red">썸네일 이미지 비율 - 가로 : 320px 세로 : 180px</p>
