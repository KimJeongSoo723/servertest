...
<input type="hidden" name="cf_popular_del" value="<?php echo $config['cf_popular_del'] ?>" id="cf_popular_del">
...
<section id="anc_cf_basic">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                <?php echo help('관리자가 보내고 받는 용도로 사용하는 메일 주소를 입력합니다.<br> (회원가입, 인증메일, 테스트, 회원메일발송 등에서 사용)') ?>
            ...
            <td>
                <?php echo help('관리자가 보내고 받는 용도로 사용하는 메일의 발송이름을 입력합니다.<br> (회원가입, 인증메일, 테스트, 회원메일발송 등에서 사용)') ?>
        ...
        <tr>
            ...
            <td><input type="checkbox" name="cf_use_point" value="1" id="cf_use_point" <?php echo $config['cf_use_point']?'checked':''; ?>> 사용</td>
...
<section id="anc_cf_join">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <th scope="row"><label for="cf_mobile_member_skin">모바일 회원 스킨<strong class="sound_only">필수</strong></label></th>
            <td>
        ...
        <tr>
            ...
            <td colspan="3"><input type="text" name="cf_register_point" value="<?php echo $config['cf_register_point'] ?>" id="cf_register_point" class="frm_input" size="5"> 점</td>
        </tr>
        <tr>
...
<section id="anc_cf_vote_mail" style="display:none">
...
<section id="anc_cf_sns" style="display:none">
...
<section id="anc_cf_lay" style="display:none">
